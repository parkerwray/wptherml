...
structure = {
        ...
        'Material_List': ['Air','SiO2','SiO2','Ag','Air'],
        ### thickness of each layer... terminal layers must be set to zero
        ### values are stored in attribute self.d
        'Thickness_List': [0, 1.5*um, 3*um, 200*nm, 0], # You can not have the back reflector as the last layer!!!
...
fill_fraction = 0.3
layer = 1
np_slab.layer_alloy(layer,fill_fraction,'Air','RC0_1B_SiO2','Bruggeman', plot = False)
...
plt.plot(np_slab.lambda_array[mask]*1e6, np_slab.thermal_emission_array[mask],'r:')
plt.show()
