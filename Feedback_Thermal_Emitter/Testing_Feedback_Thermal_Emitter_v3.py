...
structure = {
        ...
        'Time_List':[0,1*hour, 1*200], #SI unit of s  
        'Sun_Period': 0.5*hour,
        
        # Structure depenednt properties
        'Internal_Load_Flux': 1000/6,
        
        # Thermal capacitance = specific heat * mass. 
        # Specific heat of SiO2 ~680-730 J/(kg*K)
        'Thermal_Capacitance': thermal_capacitance,  #SI unit of J/(kg*K)
...
#    slab2.step_emissivity(3*um, 11*um, plot = False)
#    slab2.CPvT()
...
#dlda = 20
#slab = []
#for i in range(30-lda0-dlda):
#    start_time = time.time()
#    
#    slab.append(radiator(structure))
#    make_structure_time = time.time()
#    
#    slab[i].step_emissivity((lda0+i)*um, (lda0+dlda+i)*um, plot = False)
